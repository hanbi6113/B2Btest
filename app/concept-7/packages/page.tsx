// app/concept-7/packages/page.tsx
"use client";
...
const packages: PackageItem[] = [
  {
    ...
    fitFor: ["신작 공개", "사전예약 캠페인", "출시 직전 노출 강화"],
    ...
    panelBg:
      "bg-[radial-gradient(circle_at_top_left,rgba(139,92,246,0.30),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(59,130,246,0.18),transparent_26%),linear-gradient(180deg,#0a1020_0%,#0a1120_100%)]",
    pageGlow:
  ...
  },
  {
    ...
    fitFor: ["월간 운영 제작", "이벤트 반복 공지", "빠른 템플릿 적용"],
    ...
    panelBg:
      "bg-[radial-gradient(circle_at_top_left,rgba(34,211,238,0.28),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(59,130,246,0.14),transparent_26%),linear-gradient(180deg,#07131d_0%,#0a1720_100%)]",
    pageGlow:
  ...
  },
  {
    ...
    fitFor: ["신제품 공개", "SNS 광고", "브랜드 무드 중심 캠페인"],
    ...
    panelBg:
      "bg-[radial-gradient(circle_at_top_left,rgba(244,114,182,0.30),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(251,191,36,0.12),transparent_26%),linear-gradient(180deg,#170a14_0%,#1b0d18_100%)]",
    pageGlow:
  ...
  },
  {
    ...
    fitFor: ["수강자 유입", "학습 콘텐츠 구조화", "반복형 교육 제작"],
    note: "※ 목적에 따라 홍보형(Type A) / 학습형(Type B) 분리 운영을 권장합니다.",
    ...
    panelBg:
      "bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.30),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(16,185,129,0.12),transparent_26%),linear-gradient(180deg,#08131d_0%,#091821_100%)]",
    pageGlow:
  ...
  },
  {
    ...
    fitFor: ["시즌 컬렉션 공개", "패션 필름", "브랜드 스토리 전달"],
    ...
    panelBg:
      "bg-[radial-gradient(circle_at_top_left,rgba(251,191,36,0.28),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(244,114,182,0.12),transparent_26%),linear-gradient(180deg,#171107_0%,#1b1408_100%)]",
    pageGlow:
  ...
  },
  {
    ...
    fitFor: ["공개 전 화제성 확보", "트레일러 집행", "파생 프로모션 운영"],
    ...
    panelBg:
      "bg-[radial-gradient(circle_at_top_left,rgba(251,113,133,0.28),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(168,85,247,0.14),transparent_26%),linear-gradient(180deg,#15090d_0%,#190c11_100%)]",
    pageGlow:
  ...
  },
  {
    ...
    fitFor: ["상품 설명", "브랜드 신뢰 강화", "고객 커뮤니케이션"],
    note: "※ 준법 / 컴플라이언스 검토 추가 라운드는 별도 범위로 운영할 수 있습니다.",
    ...
    panelBg:
      "bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.26),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(56,189,248,0.12),transparent_26%),linear-gradient(180deg,#071710_0%,#0a1a15_100%)]",
    pageGlow:
  ...
  },
  {
    ...
    fitFor: ["온보딩", "반복형 사내 교육", "L&D 운영 효율화"],
    ...
    panelBg:
      "bg-[radial-gradient(circle_at_top_left,rgba(45,212,191,0.28),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(14,165,233,0.12),transparent_26%),linear-gradient(180deg,#071514_0%,#0a1818_100%)]",
    pageGlow:
  ...
  },
  {
    ...
    fitFor: ["서비스 안내", "설명형 콘텐츠", "전문 검토가 필요한 환경"],
    note: "※ 전문가 / 법무 검토가 필요한 범위는 별도 프로세스로 운영 가능합니다.",
    ...
    panelBg:
      "bg-[radial-gradient(circle_at_top_left,rgba(96,165,250,0.28),transparent_34%),radial-gradient(circle_at_bottom_right,rgba(16,185,129,0.12),transparent_26%),linear-gradient(180deg,#08111e_0%,#091421_100%)]",
    pageGlow:
...
export default function Concept7PackagesPage() {
  ...
  return (
    <main className={`min-h-screen text-white ${selected.pageGlow}`}>
      <Link
        href="/"
        className="fixed left-4 top-4 z-50 inline-flex items-center justify-center rounded-full border border-white/12 bg-[#0b1120]/82 px-4 py-2 text-sm text-white/78 shadow-[0_18px_50px_rgba(0,0,0,0.38)] backdrop-blur-md transition hover:-translate-y-0.5 hover:text-white"
      >
        home
      </Link>
      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-16">
          ...
          <h1 className="mt-5 max-w-5xl text-5xl font-semibold tracking-[-0.08em] text-white md:text-7xl xl:leading-[0.95]">
            Cinematic Packages
          ...
          <p className="mt-7 max-w-3xl text-base leading-8 text-white/72 md:text-lg">
            Vision3의 패키지는 단순 영상 묶음이 아니라, 산업군과 목적에 맞춰
            연출 감도, 전달 구조, 반복 제작 효율, 실무 신뢰도를 함께 설계한
            production-ready system입니다.
          </p>
          ...
          <div className="mt-10 grid gap-3 md:grid-cols-2 xl:grid-cols-4">
            {[
              ["Production Positioning", "툴이 아니라 제작사형 결과물 구조"],
              ["Visual Language", "산업군에 맞는 톤과 연출 감도 전환"],
              ["Execution Logic", "런칭 · 운영 · 설명 · 교육 목적 대응"],
              ["Trust Layer", "검토와 수정 부담을 줄이는 구조적 설계"],
            ].map(([title, desc]) => (
              <div
                key={title}
      ...
      <section className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-8 xl:grid-cols-[0.92fr_1.08fr] xl:items-start">
          <div className="space-y-6 xl:sticky xl:top-24">
            <div className="rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-5">
              <div className="flex items-center justify-between">
                ...
                <span className="rounded-full border border-white/10 bg-white/6 px-3 py-1 text-[11px] uppercase tracking-[0.16em] text-white/58">
                  9 options
                </span>
              </div>
                ...
                {packages.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={`group inline-flex min-h-[54px] items-center gap-2 rounded-2xl border px-3.5 py-2.5 text-left shadow-[0_10px_24px_rgba(0,0,0,0.14)] transition ${
                        active
                          ? `${selected.accentBorder} ${selected.accentBg} shadow-[0_14px_30px_rgba(0,0,0,0.18)]`
                          : "border-white/10 bg-white/6 hover:border-white/18 hover:bg-white/8"
                      }`}
                    >
                      <span
                        className={`h-2.5 w-2.5 rounded-full ${
                          active ? "bg-white" : "bg-white/28 group-hover:bg-white/40"
                        }`}
                      />
                      <div>
                        <p
                          className={`text-[9px] uppercase tracking-[0.16em] ${
                            active ? selected.accentSoft : "text-white/34"
                          }`}
                        >
                          {item.category}
                        </p>
                        <p
                          className={`mt-0.5 text-[12px] font-medium leading-4 ${
            ...
            <div className="overflow-hidden rounded-[38px] border border-white/10 bg-white/6 p-4 shadow-[0_24px_80px_rgba(0,0,0,0.42)]">
              ...
              >
                ...
                <div className="relative flex aspect-[16/10] flex-col justify-between p-7 md:p-8">
                  <div className="flex items-center justify-between">
                    <span
                      className={`rounded-full border border-white/12 bg-white/10 px-4 py-2 text-xs uppercase tracking-[0.2em] ${selected.accent}`}
                    >
                      {selected.category}
                    </span>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <p
                        className={`text-xs uppercase tracking-[0.26em] ${selected.accentSoft}`}
                      >
                        cinematic preview
                      </p>
                    </div>
                    ...
                    <p
                      className={`text-2xl font-semibold tracking-[-0.04em] md:text-3xl ${selected.accent}`}
                    >
                      {selected.preview}
                    </p>
          ...
          <div className="space-y-6">
            <div className="rounded-[34px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-7 md:p-8">
              <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                ...
                <span
                  className={`inline-flex rounded-full border px-4 py-2 text-xs uppercase tracking-[0.18em] ${selected.accentBorder} ${selected.accentBg} ${selected.accent}`}
                >
              ...
              {selected.note && (
                <div
                  className={`mt-6 rounded-[20px] border px-5 py-4 text-sm leading-7 ${selected.accentBorder} ${selected.accentBg} ${selected.accent}`}
                >
                  {selected.note}
                </div>
              )}
              ...
              <div className="rounded-[30px] border border-white/10 bg-white/5 p-6">
                ...
                <div className="mt-4 grid gap-3">
                  {selected.fitFor.map((item) => (
                    <div
                      key={item}
                      className="rounded-[18px] border border-white/10 bg-white/6 px-4 py-3 text-sm text-white/80"
                    >
                      {item}
                    </div>
                  ))}
            ...
            <div className="rounded-[30px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(255,255,255,0.06),transparent_28%),linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-6">
              <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                <div>
                  ...
                  <p className="mt-3 text-sm leading-7 text-white/68">
                    현재 선택한 패키지는 {selected.category} 산업군에 맞는 무드와
                    구조를 기준으로 전개됩니다.
                  </p>
                </div>
            ...
            <div className="rounded-[30px] border border-white/10 bg-[radial-gradient(circle_at_top_left,rgba(139,92,246,0.16),transparent_22%),linear-gradient(180deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] p-6">
              <p className={`text-xs uppercase tracking-[0.22em] ${selected.accentSoft}`}>
                next step
              </p>

              <h3 className="mt-4 text-2xl font-semibold tracking-[-0.04em] text-white">
                이 패키지가 맞는지 빠르게 확인하고 싶다면
              </h3>

              <p className="mt-4 max-w-2xl text-sm leading-8 text-white/72">
                목적, 일정, 산출물 범위, 산업군 특성을 기준으로 가장 적합한
                패키지 구조를 빠르게 정리할 수 있습니다.
              </p>

              <div className="mt-6 flex flex-wrap gap-3">
                <Link
                  href="/concept-7/support"
                  className={`inline-flex items-center justify-center rounded-full border px-5 py-3 text-sm font-medium ${selected.accentBorder} ${selected.accentBg} ${selected.accent} transition hover:-translate-y-0.5`}
                >
                  고객센터로 이동
                </Link>
                <Link
